        ...
        <PageContainer>
          <div className="py-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-h3 font-serif text-text">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-small font-medium text-muted">Type:</span>
              ...
              {/* Region Input */}
              <div className="flex items-center gap-2">
                <span className="text-small font-medium text-muted">Region:</span>
              ...
              {/* Risk Select */}
              <div className="flex items-center gap-2">
                <span className="text-small font-medium text-muted">Risk:</span>
        ...
        >
          ...
          {filteredOpportunities.length > 0 ? (
            ...
            <div className="text-center py-16">
              <div className="w-16 h-16 mx-auto bg-surface-alt rounded-full flex items-center justify-center mb-4">
